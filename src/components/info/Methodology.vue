      ...
      <div id="infoPage" class="col-12">
        <div class="row">
          <div class="col-lg-10 offset-lg-1 mb-5">
            <h1 class="mt-5 mb-5">Metodología y Fuentes</h1>
            <div>
              ...
              <p><u>Fase 3:</u> Proyecciones de Crecimiento: Desarrollo de tres escenarios de crecimiento urbano para 2030 y 2050, buscando dar herramientas a los tomadores de decisiones de políticas públicas, brindando evidencia empírica y herramientas para una mejor planeación del ordenamiento territorial que permitan un desarrollo del territorio, sostenible, incluyente y productivo.</p>
	            <p>Específicamente, se busca dar respuesta a las siguientes dos preguntas.</p>

              <ol>
                <li class="mb-2">¿Cuánta tierra cambiará su uso de rural a urbano en las próximas décadas?</li>
                <li class="mb-2">¿Qué ubicación en la periferia urbana de la ciudad tiene la mayor probabilidad de ser convertida de uso rural a uso urbana en las próximas décadas?</li>
              </ol>
              <h3 class="mt-5 mb-3">Fuentes</h3>
              <p>Las métricas se obtienen a partir de cálculos propios del Instituto Marron realizados tomando como insumo las proyecciones de población de las ciudades en la muestra que tiene el INE y los datos recolectados de las imágenes de satélite Landsat para los periodos 1985, 1998, 2008 y 2017.</p>
            </div>
          </div>
        </div>
      </div>
